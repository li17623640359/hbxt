...
MySQL - 5.7.14 : Database - thinkcmf5
*********************************************************************
*/
...
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (7,6,1,1,50,'admin','Link','index','','友情链接','','友情链接管理');
...
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (29,6,1,1,30,'admin','Nav','index','','导航管理','','导航管理');
...
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (49,109,0,1,10000,'admin','User','default','','管理组','','管理组');
...
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (78,6,1,1,40,'admin','Slide','index','','幻灯片管理','','幻灯片管理');
...
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (109,0,0,1,10,'user','AdminIndex','default','','用户管理','group','用户管理');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (110,49,1,1,10000,'admin','User','index','','管理员','','管理员管理');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (111,110,1,0,10000,'admin','User','add','','管理员添加','','管理员添加');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (112,110,2,0,10000,'admin','User','addPost','','管理员添加提交','','管理员添加提交');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (113,110,1,0,10000,'admin','User','edit','','管理员编辑','','管理员编辑');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (114,110,2,0,10000,'admin','User','editPost','','管理员编辑提交','','管理员编辑提交');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (115,110,1,0,10000,'admin','User','userInfo','','个人信息','','管理员个人信息修改');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (116,110,2,0,10000,'admin','User','userInfoPost','','管理员个人信息修改提交','','管理员个人信息修改提交');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (117,110,2,0,10000,'admin','User','delete','','管理员删除','','管理员删除');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (118,110,2,0,10000,'admin','User','ban','','停用管理员','','停用管理员');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (119,110,2,0,10000,'admin','User','cancelBan','','启用管理员','','启用管理员');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (120,0,0,1,30,'portal','AdminIndex','default','','门户管理','th','门户管理');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (121,120,1,1,10000,'portal','AdminArticle','index','','文章管理','','文章列表');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (122,121,1,0,10000,'portal','AdminArticle','add','','添加文章','','添加文章');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (123,121,2,0,10000,'portal','AdminArticle','addPost','','添加文章提交','','添加文章提交');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (124,121,1,0,10000,'portal','AdminArticle','edit','','编辑文章','','编辑文章');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (125,121,2,0,10000,'portal','AdminArticle','editPost','','编辑文章提交','','编辑文章提交');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (126,121,2,0,10000,'portal','AdminArticle','delete','','文章删除','','文章删除');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (127,121,2,0,10000,'portal','AdminArticle','publish','','文章发布','','文章发布');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (128,121,2,0,10000,'portal','AdminArticle','top','','文章置顶','','文章置顶');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (129,121,2,0,10000,'portal','AdminArticle','recommend','','文章推荐','','文章推荐');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (130,121,2,0,10000,'portal','AdminArticle','listOrder','','文章排序','','文章排序');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (131,120,1,1,10000,'portal','AdminCategory','index','','分类管理','','文章分类列表');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (132,131,1,0,10000,'portal','AdminCategory','add','','添加文章分类','','添加文章分类');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (133,131,2,0,10000,'portal','AdminCategory','addPost','','添加文章分类提交','','添加文章分类提交');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (134,131,1,0,10000,'portal','AdminCategory','edit','','编辑文章分类','','编辑文章分类');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (135,131,2,0,10000,'portal','AdminCategory','editPost','','编辑文章分类提交','','编辑文章分类提交');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (136,131,1,0,10000,'portal','AdminCategory','select','','文章分类选择对话框','','文章分类选择对话框');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (137,131,2,0,10000,'portal','AdminCategory','listOrder','','文章分类排序','','文章分类排序');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (138,131,2,0,10000,'portal','AdminCategory','delete','','删除文章分类','','删除文章分类');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (139,120,1,1,10000,'portal','AdminPage','index','','页面管理','','页面管理');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (140,139,1,0,10000,'portal','AdminPage','add','','添加页面','','添加页面');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (141,139,2,0,10000,'portal','AdminPage','addPost','','添加页面提交','','添加页面提交');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (142,139,1,0,10000,'portal','AdminPage','edit','','编辑页面','','编辑页面');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (143,139,2,0,10000,'portal','AdminPage','editPost','','编辑页面提交','','编辑页面提交');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (144,139,2,0,10000,'portal','AdminPage','delete','','删除页面','','删除页面');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (145,120,1,1,10000,'portal','AdminTag','index','','文章标签','','文章标签');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (146,145,1,0,10000,'portal','AdminTag','add','','添加文章标签','','添加文章标签');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (147,145,2,0,10000,'portal','AdminTag','addPost','','添加文章标签提交','','添加文章标签提交');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (148,145,2,0,10000,'portal','AdminTag','upStatus','','更新标签状态','','更新标签状态');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (149,145,2,0,10000,'portal','AdminTag','delete','','删除文章标签','','删除文章标签');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (150,0,1,0,10000,'user','AdminAsset','index','','资源管理','file','资源管理列表');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (151,150,2,0,10000,'user','AdminAsset','delete','','删除文件','','删除文件');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (152,109,0,1,10000,'user','AdminIndex','default1','','用户组','','用户组');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (153,152,1,1,10000,'user','AdminIndex','index','','本站用户','','本站用户');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (154,153,2,0,10000,'user','AdminIndex','ban','','本站用户拉黑','','本站用户拉黑');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (155,153,2,0,10000,'user','AdminIndex','cancelBan','','本站用户启用','','本站用户启用');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (156,152,1,1,10000,'user','AdminOauth','index','','第三方用户','','第三方用户');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (157,156,2,0,10000,'user','AdminOauth','delete','','删除第三方用户绑定','','删除第三方用户绑定');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (158,6,1,1,10000,'user','AdminUserAction','index','','用户操作管理','','用户操作管理');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (159,158,1,0,10000,'user','AdminUserAction','edit','','编辑用户操作','','编辑用户操作');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (160,158,2,0,10000,'user','AdminUserAction','editPost','','编辑用户操作提交','','编辑用户操作提交');
insert  into `cmf_admin_menu`(`id`,`parent_id`,`type`,`status`,`list_order`,`app`,`controller`,`action`,`param`,`name`,`icon`,`remark`) values (161,158,1,0,10000,'user','AdminUserAction','sync','','同步用户操作','','同步用户操作');
...
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (40,1,'admin','admin_url','admin/Plugin/default','','插件管理','');
...
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (108,1,'admin','admin_url','admin/User/default','','管理组','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (109,1,'admin','admin_url','admin/User/index','','管理员','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (110,1,'admin','admin_url','admin/User/add','','管理员添加','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (111,1,'admin','admin_url','admin/User/addPost','','管理员添加提交','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (112,1,'admin','admin_url','admin/User/edit','','管理员编辑','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (113,1,'admin','admin_url','admin/User/editPost','','管理员编辑提交','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (114,1,'admin','admin_url','admin/User/userInfo','','个人信息','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (115,1,'admin','admin_url','admin/User/userInfoPost','','管理员个人信息修改提交','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (116,1,'admin','admin_url','admin/User/delete','','管理员删除','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (117,1,'admin','admin_url','admin/User/ban','','停用管理员','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (118,1,'admin','admin_url','admin/User/cancelBan','','启用管理员','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (119,1,'portal','admin_url','portal/AdminArticle/index','','文章管理','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (120,1,'portal','admin_url','portal/AdminArticle/add','','添加文章','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (121,1,'portal','admin_url','portal/AdminArticle/addPost','','添加文章提交','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (122,1,'portal','admin_url','portal/AdminArticle/edit','','编辑文章','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (123,1,'portal','admin_url','portal/AdminArticle/editPost','','编辑文章提交','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (124,1,'portal','admin_url','portal/AdminArticle/delete','','文章删除','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (125,1,'portal','admin_url','portal/AdminArticle/publish','','文章发布','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (126,1,'portal','admin_url','portal/AdminArticle/top','','文章置顶','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (127,1,'portal','admin_url','portal/AdminArticle/recommend','','文章推荐','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (128,1,'portal','admin_url','portal/AdminArticle/listOrder','','文章排序','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (129,1,'portal','admin_url','portal/AdminCategory/index','','分类管理','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (130,1,'portal','admin_url','portal/AdminCategory/add','','添加文章分类','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (131,1,'portal','admin_url','portal/AdminCategory/addPost','','添加文章分类提交','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (132,1,'portal','admin_url','portal/AdminCategory/edit','','编辑文章分类','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (133,1,'portal','admin_url','portal/AdminCategory/editPost','','编辑文章分类提交','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (134,1,'portal','admin_url','portal/AdminCategory/select','','文章分类选择对话框','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (135,1,'portal','admin_url','portal/AdminCategory/listOrder','','文章分类排序','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (136,1,'portal','admin_url','portal/AdminCategory/delete','','删除文章分类','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (137,1,'portal','admin_url','portal/AdminIndex/default','','门户管理','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (138,1,'portal','admin_url','portal/AdminPage/index','','页面管理','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (139,1,'portal','admin_url','portal/AdminPage/add','','添加页面','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (140,1,'portal','admin_url','portal/AdminPage/addPost','','添加页面提交','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (141,1,'portal','admin_url','portal/AdminPage/edit','','编辑页面','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (142,1,'portal','admin_url','portal/AdminPage/editPost','','编辑页面提交','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (143,1,'portal','admin_url','portal/AdminPage/delete','','删除页面','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (144,1,'portal','admin_url','portal/AdminTag/index','','文章标签','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (145,1,'portal','admin_url','portal/AdminTag/add','','添加文章标签','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (146,1,'portal','admin_url','portal/AdminTag/addPost','','添加文章标签提交','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (147,1,'portal','admin_url','portal/AdminTag/upStatus','','更新标签状态','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (148,1,'portal','admin_url','portal/AdminTag/delete','','删除文章标签','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (149,1,'user','admin_url','user/AdminAsset/index','','资源管理','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (150,1,'user','admin_url','user/AdminAsset/delete','','删除文件','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (151,1,'user','admin_url','user/AdminIndex/default','','用户管理','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (152,1,'user','admin_url','user/AdminIndex/default1','','用户组','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (153,1,'user','admin_url','user/AdminIndex/index','','本站用户','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (154,1,'user','admin_url','user/AdminIndex/ban','','本站用户拉黑','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (155,1,'user','admin_url','user/AdminIndex/cancelBan','','本站用户启用','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (156,1,'user','admin_url','user/AdminOauth/index','','第三方用户','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (157,1,'user','admin_url','user/AdminOauth/delete','','删除第三方用户绑定','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (158,1,'user','admin_url','user/AdminUserAction/index','','用户操作管理','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (159,1,'user','admin_url','user/AdminUserAction/edit','','编辑用户操作','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (160,1,'user','admin_url','user/AdminUserAction/editPost','','编辑用户操作提交','');
insert  into `cmf_auth_rule`(`id`,`status`,`app`,`type`,`name`,`param`,`title`,`condition`) values (161,1,'user','admin_url','user/AdminUserAction/sync','','同步用户操作','');
...
insert  into `cmf_hook`(`id`,`type`,`once`,`name`,`hook`,`app`,`description`) values (1,1,0,'应用初始化','app_init','cmf','应用初始化');
...
insert  into `cmf_hook`(`id`,`type`,`once`,`name`,`hook`,`app`,`description`) values (30,2,0,'文章显示之前','portal_before_assign_article','portal','文章显示之前');
insert  into `cmf_hook`(`id`,`type`,`once`,`name`,`hook`,`app`,`description`) values (31,2,0,'后台文章保存之后','portal_admin_after_save_article','portal','后台文章保存之后');
...
insert  into `cmf_option`(`id`,`autoload`,`option_name`,`option_value`) values (1,1,'site_info','{\"site_name\":\"\\u6e38\\u81f4\\u79d1\\u6280\",\"site_seo_title\":\"\\u6e38\\u81f4\\u79d1\\u6280\",\"site_seo_keywords\":\"\\u6e38\\u81f4\\u79d1\\u6280\",\"site_seo_description\":\"\\u6e38\\u81f4\\u79d1\\u6280\",\"site_icp\":\"\",\"site_admin_email\":\"\",\"site_analytics\":\"\",\"urlmode\":\"1\",\"html_suffix\":\"\"}');
...
insert  into `cmf_option`(`id`,`autoload`,`option_name`,`option_value`) values (4,1,'admin_settings','{\"admin_password\":\"\",\"admin_style\":\"flatadmin\"}');
...
insert  into `cmf_portal_category`(`id`,`parent_id`,`post_count`,`status`,`delete_time`,`list_order`,`name`,`description`,`path`,`seo_title`,`seo_keywords`,`seo_description`,`list_tpl`,`one_tpl`,`more`) values (1,0,0,1,0,10000,'新闻','','0-1','','','','list','article','{\"thumbnail\":\"\"}');
...
insert  into `cmf_portal_category_post`(`id`,`post_id`,`category_id`,`list_order`,`status`) values (1,1,1,10000,1);
...
insert  into `cmf_portal_post`(`id`,`parent_id`,`post_type`,`post_format`,`user_id`,`post_status`,`comment_status`,`is_top`,`recommended`,`post_hits`,`post_like`,`comment_count`,`create_time`,`update_time`,`published_time`,`delete_time`,`post_title`,`post_keywords`,`post_excerpt`,`post_source`,`post_content`,`post_content_filtered`,`more`) values (1,0,1,1,1,1,1,0,0,1,0,0,1520414393,1520414404,1520414340,0,'测测','测测,ccc','11212','cc1','&lt;p&gt;11221212121&lt;br&gt;&lt;/p&gt;',NULL,'{\"thumbnail\":\"\",\"template\":\"\"}');
...
insert  into `cmf_portal_tag`(`id`,`status`,`recommended`,`post_count`,`name`) values (1,1,0,0,'测测');
insert  into `cmf_portal_tag`(`id`,`status`,`recommended`,`post_count`,`name`) values (2,1,0,0,'ccc');
...
insert  into `cmf_portal_tag_post`(`id`,`tag_id`,`post_id`,`status`) values (2,2,1,1);
...
CREATE TABLE `cmf_theme_file` (
  ...
  `file` varchar(50) NOT NULL DEFAULT '' COMMENT '模板文件，相对于模板根目录，如Portal/resource.html',
...
insert  into `cmf_theme_file`(`id`,`is_public`,`list_order`,`theme`,`name`,`action`,`file`,`description`,`more`,`config_more`,`draft_more`) values (6,0,10,'simpleboot3','搜索页面','portal/search/index','portal/search','搜索模板文件','{\"vars\":{\"varName1\":{\"title\":\"\\u70ed\\u95e8\\u641c\\u7d22\",\"value\":\"1\",\"type\":\"text\",\"tip\":\"\\u8fd9\\u662f\\u4e00\\u4e2atext\",\"rule\":{\"require\":true}}}}','{\"vars\":{\"varName1\":{\"title\":\"\\u70ed\\u95e8\\u641c\\u7d22\",\"value\":\"1\",\"type\":\"text\",\"tip\":\"\\u8fd9\\u662f\\u4e00\\u4e2atext\",\"rule\":{\"require\":true}}}}',NULL);
insert  into `cmf_theme_file`(`id`,`is_public`,`list_order`,`theme`,`name`,`action`,`file`,`description`,`more`,`config_more`,`draft_more`) values (7,1,0,'simpleboot3','模板全局配置','public/Config','public/config','模板全局配置文件','{\"vars\":{\"enable_mobile\":{\"title\":\"\\u624b\\u673a\\u6ce8\\u518c\",\"value\":1,\"type\":\"select\",\"options\":{\"1\":\"\\u5f00\\u542f\",\"0\":\"\\u5173\\u95ed\"},\"tip\":\"\"}}}','{\"vars\":{\"enable_mobile\":{\"title\":\"\\u624b\\u673a\\u6ce8\\u518c\",\"value\":1,\"type\":\"select\",\"options\":{\"1\":\"\\u5f00\\u542f\",\"0\":\"\\u5173\\u95ed\"},\"tip\":\"\"}}}',NULL);
...
insert  into `cmf_user`(`id`,`user_type`,`sex`,`birthday`,`last_login_time`,`score`,`coin`,`balance`,`create_time`,`user_status`,`user_login`,`user_pass`,`user_nickname`,`user_email`,`user_url`,`avatar`,`signature`,`last_login_ip`,`user_activation_key`,`mobile`,`more`) values (1,1,0,0,1521594112,0,0,'0.00',1520414308,1,'admin','###fd8460ea282a20aa07c545910b958b9a','admin','qq@126.com','','','','127.0.0.1','','',NULL);
...
insert  into `cmf_user_token`(`id`,`user_id`,`expire_time`,`create_time`,`token`,`device_type`) values (1,1,1535966323,1520414323,'0db7a40457482d4605a1c5748349ec5abdcc0abd7fdcf0b508141b4bd33eda56','web');
